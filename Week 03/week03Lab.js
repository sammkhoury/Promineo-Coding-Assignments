...
const alphabetStringCopy = alphabetString.split();
...
myTodoList.push('Clean yard', 'Wash clothes', 'Cook dinner');
console.log(myTodoList);
...
let yourTodoList = [];
yourTodoList.push('Clean the car', 'Cut the grass');
...
function addingMachine([input]) {
       let sum = 0;
       for (i = 0; i < addingMachine.length; i++) {
              sum += addingMachine[i];
       }
}
